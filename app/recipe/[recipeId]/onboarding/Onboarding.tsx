...
export default function Onboarding({ recipeId }: { recipeId: string }) {
  ...
  if (recipeQuery.isLoading) return null;
            ...
            <div>
              ...
              <div>
                <input
                  ...
                  readOnly
                />
                <div className="flex w-full justify-between px-2 text-xs leading-3">
